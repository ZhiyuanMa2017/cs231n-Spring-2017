...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_affinerelu,cache_affinerelu = affine_relu_forward(out_conv,W2,b2)
        scores,scores_cache = affine_forward(out_affinerelu,W3,b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx2, dW3, db3 = affine_backward(dscores, scores_cache)
        dW3 += self.reg * W3
        dx1, dW2, db2 = affine_relu_backward(dx2, cache_affinerelu)
        dW2 += self.reg * W2
        dx, dW1, db1 = conv_relu_pool_backward(dx1,cache_conv)
        dW1 += self.reg * W1
        grads['W1'] = dW1
        grads['W2'] = dW2
        grads['W3'] = dW3
